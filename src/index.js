...
function formatString(input, toUpper) {
    if (toUpper === false) {
        return "".concat(input.toLowerCase());
    }
    return "".concat(input.toUpperCase());
}
...
function concatenateArrays() {
    ...
    return arrays.reduce(function (acc, item) { return acc.concat(item); }, []);
}
...
var Car = /** @class */ (function (_super) {
    ...
    Car.prototype.getModel = function (modelInfo) {
